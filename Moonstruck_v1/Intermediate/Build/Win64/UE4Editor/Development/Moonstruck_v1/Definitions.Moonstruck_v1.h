#undef MOONSTRUCK_V1_API
#undef MOONSTRUCK_V1_VTABLE
...
#define UE_PROJECT_NAME Moonstruck_v1
...
#define MOONSTRUCK_V1_VTABLE DLLEXPORT_VTABLE
#define MOONSTRUCK_V1_API DLLEXPORT
